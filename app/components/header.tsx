            ...
            <div className='col-span-10'>
              ...
              <div className="md:hidden">
                ...
                {user?.publicMetadata.role == "super_admin" ? (
                  <><Link href="/dashboard" style={{ color: "skyblue", paddingRight: "10px", paddingLeft: "5px" }}>Home</Link>
                    <Link href="/superadmin/changerole" style={{ color: "skyblue", paddingRight: "10px" }}>Roles</Link>
                    <Link href="/superadmin/inviteuser" style={{ color: "skyblue", paddingRight: "20px" }}>Invite</Link></>) : (<Link href="/dashboard" style={{ color: "skyblue", paddingRight: "20px", paddingLeft: "100px" }}>Home</Link>)}
                < UserButton />
              </div>
            </div>
            ...
            <div className="col-span-2 sm:block hidden pt-5">
              {user?.publicMetadata.role == "super_admin" ? (
                <><Link href="/dashboard" style={{ color: "skyblue", paddingRight: "10px" }}>Home</Link>
                  <Link href="/superadmin/changerole" style={{ color: "skyblue", paddingRight: "10px" }}>Roles</Link>
                  <Link href="/superadmin/inviteuser" style={{ color: "skyblue", paddingRight: "20px" }}>Invite</Link></>) : (<Link href="/dashboard" style={{ color: "skyblue", paddingRight: "20px" }}>Home</Link>)}
              < UserButton />
            </div>
